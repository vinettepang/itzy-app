(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[605],{
1827:function(e,t,a){
Promise.resolve().then(a.t.bind(a,908,23)),Promise.resolve().then(a.bind(a,6750))},6750:function(e,t,a){
"use strict";
a.d(t,{
default:function(){
return x}});
...
ref:e,className:"paper-noise",width:"800",height:"400","aria-hidden":"true"})}function h(e){
let{
...
x:"474",y:"13",className:"ticket-year",transform:"rotate(90 474 13)",children:"2026"})]})}async function m(e){
let t=e.cloneNode(!0);
...
n.onload=e,n.onerror=t,n.src=r}),URL.revokeObjectURL(r),n}async function f(e){
...
return o.fillStyle="#2E1F15",o.fillRect(0,0,n.width,n.height),o.drawImage(t,300,360),new Promise(e=>n.toBlob(e,"image/png"))}function x(e){
let{
name:t}=e,a=function(){
