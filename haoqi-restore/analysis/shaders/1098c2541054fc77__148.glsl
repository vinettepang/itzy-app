).value+e)*2&&(this.active=!1,o.value=!1)}}},tm=`#include <common>
#include <packing>
...
bool keep=!isMaxDepth&&depthTest(depth.x,depth.y);
#endif
if(keep){gl_FragColor=texture2D(inputBuffer,vUv);}else{discard;}}`,tg=class extends O.ShaderMaterial{constructor(){super({name: